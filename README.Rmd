...
# Reproduce Results of @gerard2017adaptive
This folder contains the code necessary to reproduce the results of @gerard2017adaptive. To reproduce these results you will need to:
...
# Run `make`
To reproduce all of the results of @gerard2017adaptive, simply run `make` from the terminal (not in the R session). To reproduce the figure from Section 2, run in the terminal:
``` shell
make change_sv
```
